...
public class CrewRequestDTO {
    ...
    // Constructor
    public CrewRequestDTO(String id, String employeeId, String firstName, String lastName,
    ...
    public Integer getFlightHoursMonth() {
        return flightHoursMonth;
    }

    public void setFlightHoursMonth(Integer flightHoursMonth) {
        this.flightHoursMonth = flightHoursMonth;
    }

    public Integer getFlightHoursMax() {
        return flightHoursMax;
    }

    public void setFlightHoursMax(Integer flightHoursMax) {
        this.flightHoursMax = flightHoursMax;
    }
}
